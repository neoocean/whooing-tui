...
from whooing_tui.screens.entries_scan import ScanMixin
...
class EntriesScreen(ScanMixin, MenuBarMixin, Screen):
    """활성 섹션의 거래내역 화면. F10 메뉴바 (MenuBarMixin).

    중복/반복 스캔 worker 는 `ScanMixin`(`screens/entries_scan.py`) 으로 분리.
    """
