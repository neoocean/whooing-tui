...
**현재 0.60.0 (CL #52763, 2026-05-18)** — Phase 1~7 + 다음 누적 변경.
...
| **`m`** | **선택 거래의 context menu popup (0.60.0+)** | 〃 |
| `c` | 활성 필터 해제 | 〃 |
| `s` | 섹션 picker 모달 | 〃 |
| `a` | 계정과목 화면 | 〃 |
...
| `+` / `-` | 조회 윈도우 ±7일 | 〃 |
| `F10` / `Alt+M` / `Alt+F` | F10 메뉴 진입 (0.58.0+) | 〃 |
| `?` | 화면 도움말 | 〃 |
...
**현재 통계**: tui + core 합 **885 passed** (0.60.0 기준, 2026-05-18).
